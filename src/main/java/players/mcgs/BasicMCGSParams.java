...
public class BasicMCGSParams extends PlayerParameters {
    ...
    public BasicMCGSParams() {
        this(System.currentTimeMillis());
    }

    public BasicMCGSParams(long seed) {
        super(seed);
    ...
    @Override
    protected BasicMCGSParams _copy() {
        BasicMCGSParams retValue = new BasicMCGSParams(System.currentTimeMillis());
        retValue.K = K;
